...
//		CameraModel cm = new CameraModel(new MatOfDouble(2300, 0, lastImage.cols()/2, 0, 2300, lastImage.rows()/2, 0, 0, 1).reshape(1, 3));
...
//		}
		perspectiveImage=Imgcodecs.imread("CVdata/sfm_avatar/desired.jpg");
